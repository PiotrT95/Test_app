 //document.addEventListener("deviceready", onDeviceReady, false);
    ...
    function populateBuildingDB(tx2) {
        ...
        tx2.executeSql('INSERT INTO Building(BuildingName,BuildingPhoto,BuildingLocalization,BuildingUsefulPlaces,BuildingRooms) VALUES ("Wawel", "<img id=theImg src=img/wawel.jpg />", "<img id=theImg src=img/bgloc.png />", "Dziekanaty:<br> Godziny otwarcia: <br>poniedziałek, wtorek, czwartek w godzinach: 11.00-14.00<br>piątek w godzinach: 11.00-14.00 i 15:00-17:00<br>środa - dziekanat nieczynny <br> sobota  w godzinach: 8.00-12.00 ", "-Piwnica: 1 (sala obron), 2 (sala obron), 3, 4, 5, 6 <br>-1 piętro: 7, 8, Stara Aula")'); 
