 //document.addEventListener("deviceready", onDeviceReady, false);
    ...
    function populateBuildingDB(tx2) {
        ...
        tx2.executeSql('INSERT INTO Building(BuildingName,BuildingPhoto,BuildingLocalization,BuildingUsefulPlaces,BuildingRooms) VALUES ("Budynek Główny", "<img id=theImg src=img/splashphoto.png />", "<img id=theImg src=img/bgloc.png />", "Dziekanaty:<br> Godziny otwarcia: <br>poniedziałek, wtorek, czwartek w godzinach: 11.00-14.00<br>piątek w godzinach: 11.00-14.00 i 15:00-17:00<br>środa - dziekanat nieczynny <br> sobota  w godzinach: 8.00-12.00 ", "-Piwnica: 1 (sala obron), 2 (sala obron), 3, 4, 5, 6 <br>-1 piętro: 7, 8, Stara Aula")'); 
        tx2.executeSql('INSERT INTO Building(BuildingName,BuildingPhoto,BuildingLocalization,BuildingUsefulPlaces,BuildingRooms) VALUES ("Biblioteka", "<img id=theImg src=img/splashphoto.png />", "<img id=theImg src=img/bibloc.png />", "Wypożyczalnia ogólna - 1 piętro (p.102):<br> Godziny otwarcia: <br>Pn. 10:00 - 18:00<br>Wt. - Pt. 9:00 - 18:00<br>Sob. 9:00 - 15:00<br>Nd. 9:00 - 14:00", "-4 piętro: 440, 441, 442, 443")'); 
        tx2.executeSql('INSERT INTO Building(BuildingName,BuildingPhoto,BuildingLocalization,BuildingUsefulPlaces,BuildingRooms) VALUES ("Pawilon A", "<img id=theImg src=img/splashphoto.png />", "<img id=theImg src=img/aloc.png />", "Sale pracy samodzielnej - parter (07, 09, 013, 014)<br>Godziny pracy samodzielnej pod adresem <a onclick=loadPage(http://uek.krakow.pl/pl/uczelnia/administracja-i-inne-jednostki/pion-kanclerza/jednostki-bezposrednio-podlegle-kanclerzowi/centrum-informatyki/laboratoria/praca-indywidualna.html);>http://uek.krakow.pl/pl/uczelnia/administracja-i-inne-jednostki/pion-kanclerza/jednostki-bezposrednio-podlegle-kanclerzowi/centrum-informatyki/laboratoria/praca-indywidualna.html</a>", "-Parter: 07, 09, 013, 014 <br>-1 piętro: 115, 116, 117, 118, 121, 122<br>-2 piętro: 201 <br>-3 piętro: 301a, 301b <br>-4 piętro: 410, 413")'); 
        tx2.executeSql('INSERT INTO Building(BuildingName,BuildingPhoto,BuildingLocalization,BuildingUsefulPlaces,BuildingRooms) VALUES ("Pawilon B", "<img id=theImg src=img/splashphoto.png />", "<img id=theImg src=img/bloc.png />", "-460(sekretariat katedry przedsiębiorczości i innowacji)<br>-469(sekretariat katedry nauk politycznych)", "-Parter: 052, 053, 054, 055, 056, 057, 058, 059 <br> 1 piętro: 151, 152, 153 <br>-2 piętro: 251 <br>-3 piętro: 351 <br>-4 piętro: 451")'); 
        tx2.executeSql('INSERT INTO Building(BuildingName,BuildingPhoto,BuildingLocalization,BuildingUsefulPlaces,BuildingRooms) VALUES ("Pawilon C", "<img id=theImg src=img/splashphoto.png />", "<img id=theImg src=img/cloc.png />", "-Siłownia (piwnica)<br>-Chór Dominanta (p.01a - parter)", "-Parter: A, B, C, D <br>-1 piętro: Nowa Aula, E, F")'); 
        tx2.executeSql('INSERT INTO Building(BuildingName,BuildingPhoto,BuildingLocalization,BuildingUsefulPlaces,BuildingRooms) VALUES ("Pawilon D", "<img id=theImg src=img/splashphoto.png />", "<img id=theImg src=img/dloc.png />", "-Gabinet psychologa (p.18)<br>-Zrzeszenie studentów niepełnosprawnych (p.19)<br>-Biuro ds. osób niepełnosprawnych (p.20)", "-Parter: 3, 4, 5, 6, Prac. Mikrob. 1, Prac. Mikrob. 2")'); 
        tx2.executeSql('INSERT INTO Building(BuildingName,BuildingPhoto,BuildingLocalization,BuildingUsefulPlaces,BuildingRooms) VALUES ("Pawilon E", "<img id=theImg src=img/splashphoto.png />", "<img id=theImg src=img/eloc.png />", "-Klub Studencki ZaUEK - wejście od pola<br>Więcej informacji pod adresem <a onclick=loadPage(https://www.facebook.com/zauek/);>https://www.facebook.com/zauek/</a>", "-Parter: G, H <br>-1 piętro: J")'); 
        tx2.executeSql('INSERT INTO Building(BuildingName,BuildingPhoto,BuildingLocalization,BuildingUsefulPlaces,BuildingRooms) VALUES ("Pawilon F", "<img id=theImg src=img/splashphoto.png />", "<img id=theImg src=img/floc.png />", "-Restauracja Bułka z makiem - parter<br>-Bankomat Euronet - parter", "-Parter: 011(SJO), 012(SJO) <br>-1 piętro: 102, 104, 106, 107, 109, 111<br>-2 piętro: 210(SJO)<br>-3 piętro: 301(SJO), 302(SJO), 303(SJO), 309(SJO), 310(SJO), 311(SJO), 312(SJO), 313(SJO), 314(SJO)<br>-4 piętro: 413, 414, 415, 416<br>-5 piętro: 513, 514, 515, 516<br>-6 piętro: 613, 614, 615, 616<br>-7 piętro: 713, 715, 717")'); 
        tx2.executeSql('INSERT INTO Building(BuildingName,BuildingPhoto,BuildingLocalization,BuildingUsefulPlaces,BuildingRooms) VALUES ("Pawilon G", "<img id=theImg src=img/splashphoto.png />", "<img id=theImg src=img/gloc.png />", "---", "-Piwnica: 1, 2, 3 <br>-Parter: 4, 5, 6, 7 <br>-1 piętro: 8, 9, 10, 11<br>-2 piętro: 12, 14, 15")'); 
        tx2.executeSql('INSERT INTO Building(BuildingName,BuildingPhoto,BuildingLocalization,BuildingUsefulPlaces,BuildingRooms) VALUES ("Ustronie", "<img id=theImg src=img/splashphoto.png />", "<img id=theImg src=img/uloc.png />", "-Stołówka UEK<br>Godziny otwarcia:<br>poniedziałek–piątek: 10:00–16:30<br> do godziny 11:30 dania barowe, po godzinie 11:30 obiady", "-1 piętro: K, L, M, N <br>-2 piętro: O, P, S <br>-3 piętro: T, Lab. Fiz. 1, Lab. Fiz. 2 <br>-4 piętro: Lab. Prz. 1, Lab. Opakowań 1")'); 
        tx2.executeSql('INSERT INTO Building(BuildingName,BuildingPhoto,BuildingLocalization,BuildingUsefulPlaces,BuildingRooms) VALUES ("Pawilon Sportowy", "<img id=theImg src=img/splashphoto.png />", "<img id=theImg src=img/sloc.png />", "Restauracja Dobre smaki<br>Godziny otwarcia: <br>poniedziałek–sobota: 8:00–19:00<br> niedziela: 8:00–16:00", "-Piwnica: Szatnie, Wejście na halę sportową <br>-1 piętro: 1, 2, 3, 4, 5 <br>-2 piętro: 6, 7, 8, 9")'); 
        tx2.executeSql('INSERT INTO Building(BuildingName,BuildingPhoto,BuildingLocalization,BuildingUsefulPlaces,BuildingRooms) VALUES ("Księżówka", "<img id=theImg src=img/splashphoto.png />", "<img id=theImg src=img/kloc.png />", "Klub studencki Grota 2 <br>Godziny otwarcia: <br>poniedziałek–piątek:  9:00–22:00<br> sobota: 9:00–17:00<br> niedziela: 9:00–15:00", "-Parter: Sala seminaryjna")'); 
        }
